<template>
	...
	<cell>
		...
		<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'"
		 class="uni-list-item" @click="onClick" :hover-stay-time="150">
			<view class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
				...
				<view v-else-if="iconfont" class="uni-list-item__icon">
					<text class="iconfont font-md" :class="iconfont"></text>
				</view>
...
<style lang="scss" scoped>
	$list-item-pd: 30rpx $uni-spacing-row-lg;
